                ...
                @forelse($categories as $key => $category)
                    <tr class="border-t" role="row">
                        ...
                        <td class="px-5 py-4" data-label="Image" role="cell">
                            ...
                            @else
                                <div
                                    class="h-10 w-10 bg-gray-200 flex items-center justify-center rounded text-xs text-gray-500">
                                    N/A</div>
                            @endif
                        </td>
                        ...
                        <td class="px-5 py-4 text-zinc-700 max-w-xs whitespace-pre-line break-words"
                            data-label="Description" role="cell">
                        ...
                        <td class="px-5 py-4" data-label="On/Off" role="cell">
                            <form id="toggle-form-{{ $category->id }}"
                                action="{{ route('categories.toggle', $category->id) }}" method="POST"
                        ...
                        <td>
                            <form id="sync-category-{{ $category->id }}"
                                ...
                                <input type="hidden" name="is_active"
                                    value="@if($category->hub_category_id) 1 @else 0 @endif">
                        ...
                        <td class="px-5 py-4" data-label="Actions" role="cell">
                            <flux:dropdown>
                                <flux:button icon:trailing="chevron-down" size="sm" class="btn-actions">Actions
                                </flux:button>
                                <flux:menu>
                                    <flux:menu.item icon="pencil" href="{{ route('categories.edit', $category->id) }}">Edit
                                    </flux:menu.item>
